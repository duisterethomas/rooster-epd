...
class Ui_Rooster_epd(object):
    def setupUi(self, Rooster_epd):
        ...
        Rooster_epd.setMinimumSize(QSize(201, 111))
        Rooster_epd.setMaximumSize(QSize(201, 111))
        ...
        self.sync.setGeometry(QRect(10, 40, 181, 24))
        self.retry_connection_button = QPushButton(self.centralwidget)
        self.retry_connection_button.setObjectName(u"retry_connection_button")
        self.retry_connection_button.setGeometry(QRect(10, 10, 181, 24))
        ...
        self.menuBar.setGeometry(QRect(0, 0, 201, 22))
    ...
    def retranslateUi(self, Rooster_epd):
        ...
        self.retry_connection_button.setText(QCoreApplication.translate("Rooster_epd", u"Retry connection", None))
